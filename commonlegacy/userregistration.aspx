<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="userregistration.aspx.cs" Inherits="commonlegacy.userregistration" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
        <link rel="stylesheet" type="text/css" href="/lib/css/userregistration.css" />
        <script src="./lib/js/userregistration.js" language="javascript" type="text/javascript"></script>
</asp:Content>
